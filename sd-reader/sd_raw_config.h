...
/* defines for customisation of sd/mmc port access */
    ...
    //#define configure_pin_mosi() DDRF |= (1 << DDF4) //F4
    //#define configure_pin_sck() DDRF |= (1 << DDF5) //F5
    //#define configure_pin_ss() DDRF |= (1 << DDF6) //F6
    //#define configure_pin_miso() DDRF &= ~(1 << DDF3) //F3
